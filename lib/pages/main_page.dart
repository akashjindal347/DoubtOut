  ...
  Widget build(BuildContext context)
  {
    ...
    (
      ...
      (
        ...
        title: Text('DoubtOut', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
                      ...
                      (
                        ...
                        [
                          ...
                          (
                            ...
                            children: <Widget>
                            [
                              Text('Doubts Solved', style: TextStyle(color: Colors.green)),
                              Text('12', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
            ...
            Padding(
              ...
              (
                ...
                [
                  ...
                  Text('Maths', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
            ...
            (
              ...
              (
                ...
                [
                  ...
                  Padding(padding: EdgeInsets.only(bottom: 16.0)),
                  Text('Science', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    (
                      padding: const EdgeInsets.all(16.0),
                      child: Icon(Icons.settings_backup_restore, color: Colors.white, size: 30.0),
                    )
                  ),
                  Padding(padding: EdgeInsets.only(bottom: 16.0)),
